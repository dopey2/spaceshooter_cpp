...
int main() {
    ...
    Application* application = Application::createInstance("Spaceship", width, height, targetFps);
    ...
    // scenes creation
    // do note delete scenes manually, SceneManager takes ownership over it and
    // handle it implicitely
    ...
    // start app
    // application being a singleton must be deleted manually after it stops
    // running
    application->run();
    delete application;
    return 0;
